...
* **ARC VPN**: We recommend that you utilize our [VPN module](https://github.com/sourcefuse/terraform-aws-refarch-vpn), as it is already proven to integrate with the LZA hub and spoke network architecture. If you are unable to use the module, we recommend creating the VPN manually.
