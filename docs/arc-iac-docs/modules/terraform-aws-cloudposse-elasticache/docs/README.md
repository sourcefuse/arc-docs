# [cloudposse/terraform-aws-elasticache-redis](https://github.com/cloudposse/terraform-aws-elasticache-redis)

## Overview

SourceFuse recommends using Terraform elasticache-redis module from cloudposse. This robust, open-source solution enables rapid provisioning of highly available clusters. Leverage this module for consistent configurations, customize your cluster with ease, and minimize deployment risks.
...
## Usage
To see a full example, check out the [main.tf](https://github.com/cloudposse/terraform-aws-elasticache-redis/blob/main/examples/complete/main.tf) file in the example folder.
...
module "redis" {
  ...
  subnets                          = data.subnets.private_subnet_ids
