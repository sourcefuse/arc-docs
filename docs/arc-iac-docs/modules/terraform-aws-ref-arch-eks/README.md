...
the variable `map_additional_iam_roles` as well the caller iam identity. It also creates 
a role which can be assumed to get admin access to the cluster. Beyond that, it does not
