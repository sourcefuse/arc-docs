...
[services/user-tenant-service/src/models/group.model.ts:65](https://github.com/sourcefuse/loopback4-microservice-catalog/blob/d35fdb3f0/services/user-tenant-service/src/models/group.model.ts#L65)
...
[services/user-tenant-service/src/enums/role-type.enum.ts:19](https://github.com/sourcefuse/loopback4-microservice-catalog/blob/d35fdb3f0/services/user-tenant-service/src/enums/role-type.enum.ts#L19)
...
[services/user-tenant-service/src/models/role.model.ts:66](https://github.com/sourcefuse/loopback4-microservice-catalog/blob/d35fdb3f0/services/user-tenant-service/src/models/role.model.ts#L66)
...
[services/user-tenant-service/src/models/tenant-config.model.ts:47](https://github.com/sourcefuse/loopback4-microservice-catalog/blob/d35fdb3f0/services/user-tenant-service/src/models/tenant-config.model.ts#L47)
...
[services/user-tenant-service/src/models/tenant.model.ts:108](https://github.com/sourcefuse/loopback4-microservice-catalog/blob/d35fdb3f0/services/user-tenant-service/src/models/tenant.model.ts#L108)
...
[services/user-tenant-service/src/models/user-credentials.model.ts:65](https://github.com/sourcefuse/loopback4-microservice-catalog/blob/d35fdb3f0/services/user-tenant-service/src/models/user-credentials.model.ts#L65)
...
[services/user-tenant-service/src/models/user-group.model.ts:57](https://github.com/sourcefuse/loopback4-microservice-catalog/blob/d35fdb3f0/services/user-tenant-service/src/models/user-group.model.ts#L57)
...
[services/user-tenant-service/src/models/user-tenant.model.ts:87](https://github.com/sourcefuse/loopback4-microservice-catalog/blob/d35fdb3f0/services/user-tenant-service/src/models/user-tenant.model.ts#L87)
...
[services/user-tenant-service/src/models/user.model.ts:146](https://github.com/sourcefuse/loopback4-microservice-catalog/blob/d35fdb3f0/services/user-tenant-service/src/models/user.model.ts#L146)
...
[services/user-tenant-service/src/types.ts:18](https://github.com/sourcefuse/loopback4-microservice-catalog/blob/d35fdb3f0/services/user-tenant-service/src/types.ts#L18)
...
[services/user-tenant-service/src/enums/role-type.enum.ts:21](https://github.com/sourcefuse/loopback4-microservice-catalog/blob/d35fdb3f0/services/user-tenant-service/src/enums/role-type.enum.ts#L21)
...
[services/user-tenant-service/src/enums/role-type.enum.ts:27](https://github.com/sourcefuse/loopback4-microservice-catalog/blob/d35fdb3f0/services/user-tenant-service/src/enums/role-type.enum.ts#L27)
...
[services/user-tenant-service/src/keys.ts:18](https://github.com/sourcefuse/loopback4-microservice-catalog/blob/d35fdb3f0/services/user-tenant-service/src/keys.ts#L18)
...
[services/user-tenant-service/src/keys.ts:17](https://github.com/sourcefuse/loopback4-microservice-catalog/blob/d35fdb3f0/services/user-tenant-service/src/keys.ts#L17)
