[@sourceloop/user-tenant-service](../README.md) / [Exports](../modules.md) / AuditLogRepository
...
[services/user-tenant-service/src/repositories/audit.repository.ts:16](https://github.com/sourcefuse/loopback4-microservice-catalog/blob/68ec38a2a/services/user-tenant-service/src/repositories/audit.repository.ts#L16)
